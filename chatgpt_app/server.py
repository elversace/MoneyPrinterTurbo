...
MPT_LOCAL_BACKGROUND = os.getenv(
    "MPT_LOCAL_BACKGROUND",
    "/MoneyPrinterTurbo/resource/local/tiktok-background.mp4",
).strip()
...
async def tiktok_defaults() -> dict[str, Any]:
    return {
        ...
        "external_script_llm_required": False,
        "stock_video_api_key_required": False,
        "subtitle_translation_provider_required": True,
    }
